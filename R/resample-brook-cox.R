...
outfile <- "data/cox-resamples-brook/points-brook-cox"
...
#load("brook-image.rdata")
load("data/brook-cox.rdata")
...
sim <- simulate2.lppm(obj$dwpr, lambda=lam, lmax=lmax, effort=eff, nzw.rids=obs.rids)
